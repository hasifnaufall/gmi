...
class _FruitsLearnScreenState extends State<FruitsLearnScreen> {
  ...
  final List<Map<String, String>> _all = [
    {"label": "Apple", "video": "assets/videos/fruits/apple.mp4"},
    {"label": "Banana", "video": "assets/videos/fruits/banana.mp4"},
    {"label": "Ciku", "video": "assets/videos/fruits/ciku.mp4"},
    {"label": "Coconut", "video": "assets/videos/fruits/coconut.mp4"},
    {"label": "Corn", "video": "assets/videos/fruits/corn.mp4"},
    {"label": "Duku", "video": "assets/videos/fruits/duku.mp4"},
    {"label": "Durian", "video": "assets/videos/fruits/durian.mp4"},
    {"label": "Grape", "video": "assets/videos/fruits/grape.mp4"},
    {"label": "Langsat", "video": "assets/videos/fruits/langsat.mp4"},
    {"label": "Lemon", "video": "assets/videos/fruits/lemon.mp4"},
    {"label": "Mangga", "video": "assets/videos/fruits/mangga.mp4"},
    {"label": "Mangosteen", "video": "assets/videos/fruits/mangosteen.mp4"},
    {"label": "Orange", "video": "assets/videos/fruits/orange.mp4"},
    {"label": "Papaya", "video": "assets/videos/fruits/papaya.mp4"},
    {"label": "Peanut", "video": "assets/videos/fruits/peanut.mp4"},
    {"label": "Pear", "video": "assets/videos/fruits/pear.mp4"},
    {"label": "Pineapple", "video": "assets/videos/fruits/pineapple.mp4"},
    {"label": "Pomelo", "video": "assets/videos/fruits/pomelo.mp4"},
  ...
  String _query = "";
  int _columns = 3;
  bool _notifiedAllLearned = false; // ✅ ADDED: avoid duplicate notifications
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "$watchedCount / ${_all.length} Fruits",
                                style: GoogleFonts.montserrat(
                                  fontSize: 24,
                                  color: Colors.white,
