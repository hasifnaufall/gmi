...
class _SpeechLearnScreenState extends State<SpeechLearnScreen> {
  ...
  final List<Map<String, String>> _all = [
    ...
    {'label': 'Peace Be Upon You', 'video': 'assets/videos/speechs/pbay.mp4'},
    {'label': 'Hello', 'video': 'assets/videos/speechs/hello.mp4'},
    {'label': 'Excuse', 'video': 'assets/videos/speechs/excuse.mp4'},
    {'label': 'Sorry', 'video': 'assets/videos/speechs/sorry.mp4'},
    {'label': 'Salam', 'video': 'assets/videos/speechs/salam.mp4'},
    {'label': 'Regards', 'video': 'assets/videos/speechs/regards.mp4'},
    {'label': 'You are Welcome', 'video': 'assets/videos/speechs/yaw.mp4'},
    {'label': 'Well', 'video': 'assets/videos/speechs/well.mp4'},
    {'label': 'Welcome', 'video': 'assets/videos/speechs/welcome.mp4'},
    {'label': 'Happy Birthday', 'video': 'assets/videos/speechs/birthday.mp4'},
    {'label': 'Goodbye', 'video': 'assets/videos/speechs/goodbye.mp4'},
    {'label': 'Good Night', 'video': 'assets/videos/speechs/goodnight.mp4'},
    {'label': 'Good Morning', 'video': 'assets/videos/speechs/goodmorning.mp4'},
    {'label': 'Good Evening', 'video': 'assets/videos/speechs/goodevening.mp4'},
    {'label': 'Good Afternoon', 'video': 'assets/videos/speechs/afternoon.mp4'},
    {'label': 'Congratulations', 'video': 'assets/videos/speechs/congrats.mp4'},
    {'label': 'Thank you', 'video': 'assets/videos/speechs/thankyou.mp4'},
    {'label': 'PLease', 'video': 'assets/videos/speechs/please.mp4'},
    {'label': 'And unto you peace', 'video': 'assets/videos/speechs/auyp.mp4'},
  ];
