...
Future<void> showAnimalQuizSelection(BuildContext context) {
          ...
          _CompactQuizCard(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const AnimalQuizScreen(quizType: QuizType.multipleChoice),
                ),
              );
            },
          ),
          ...
          _CompactQuizCard(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const AnimalQuizScreen(quizType: QuizType.mixMatch),
                ),
              );
            },
          ),
          ...
          _CompactQuizCard(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const AnimalQuizScreen(quizType: QuizType.both),
                ),
              );
            },
          ),
...
class _AnimalQuizScreenState extends State<AnimalQuizScreen>
  ...
  static const double mmImageHeight = 95;   // animal image box
  static const double mmNameHeight = 70;    // name box
  ...
  void _prepareMixMatchRound() {
    ...
    final names = mixMatchIndices.map((i) => questions[i]['correctName'] as String).toList();
  ...
  Widget _buildMixMatchQuiz() {
    if (_mmNamesOrder.isEmpty || _mmImagesOrder.isEmpty) {
      _prepareMixMatchRound();
    }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text("Drag names to their matching animals", style: GoogleFonts.montserrat(fontSize: 14, fontWeight: FontWeight.w700, color: const Color(0xFF69D3E4))),
          ),
        ],
      ),
    );
  ...
  Widget _buildMatchingAreaStable({
    required List<String> namesOrder,
    required List<String> imagesOrder,
  }) {
    assert(namesOrder.length == imagesOrder.length, "namesOrder and imagesOrder must be same length");
        ...
        return Padding(
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                // Left: draggable name (disabled in review)
                Expanded(
                  flex: 1,
                  child: Center(
                    child: SizedBox(
                        ...
                        child: IgnorePointer(
                          ...
                          child: Draggable<String>(
                            ...
                            feedback: Material(
                              elevation: 8,
                              borderRadius: BorderRadius.circular(16),
                              child: _NameCard(name: name, isFloating: true),
                            ),
                            childWhenDragging: Opacity(opacity: 0.3, child: _NameCard(name: name)),
                            child: _NameCard(name: name, isMatched: isLeftMatched),
                          ),
                        ),
                      ),
                    ),
  ...
  Widget _buildQuestionCard(Map<String, dynamic> question) {
    return Container(
      ...
      child: Column(
        children: [
          Text("What animal is shown?", textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 18, fontWeight: FontWeight.w800, color: const Color(0xFF69D3E4), letterSpacing: -0.3)),
          const SizedBox(height: 20),
          Container(
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 12),
          Text('Great job! Now drag names to their matching animals.', textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 15, color: const Color(0xFF6B7280), height: 1.5)),
