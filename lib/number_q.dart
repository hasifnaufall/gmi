      ...
      if (_allAnsweredInSession()) {
        ...
        if (isPerfect) {
          ...
          if (QuestStatus.canClaimQuest9()) {
            ...
            _showToast(icon: Icons.stars, title: "Quest 9 Complete!", subtitle: "Perfect round! +200 keys", bgColor: const Color(0xFF2C5CB0));
        ...
        if (QuestStatus.numbersRoundsCompleted >= 3 && !QuestStatus.quest10Claimed) {
          if (QuestStatus.canClaimQuest10()) {
            ...
            await Future.delayed(const Duration(milliseconds: 500));
            _showToast(icon: Icons.military_tech, title: "Quest 10 Complete!", subtitle: "3 rounds finished! +200 keys", bgColor: const Color(0xFFFF4B4A));
            await Future.delayed(const Duration(seconds: 2));
          }
        }
    ...
    void _showToast({
      ...
      final entry = OverlayEntry(
        builder: (_) => Positioned(
          top: 60,
          right: 16,
          child: _NumberSlideInPopup(icon: icon, title: title, subtitle: subtitle, bgColor: bgColor),
        ),
      );
